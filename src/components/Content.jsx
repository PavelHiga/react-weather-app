    ...
    return (
        <div className="">
            <div className="p-5 text-center justify-center">
                ...
                <img className='w-52 h-52 mx-auto' src={`/src/assets/${data.weather[0].main}.png`} alt="" />
            ...
            <div className="flex w-10/12 mx-auto pb-14">
                <div className="flex items-center justify-center w-full">
                    <img className='w-14 h-14' src="/src/assets/icons/drop.svg" alt="" />
                ...
                <div className="flex items-center justify-center w-full">
                    <img className='w-16 h-16' src="/src/assets/icons/wind.svg" alt="" />
                    <div className="text-2xl ml-2 font-medium text-gray-600 text-center">
